...
//
var stream=fs.createWriteStream("../text.txt");
...
function sendWord(word) {
  ...
  //
  stream.while(bitsUtils.printBuffer(binaryData)+"\n");
        console.log(`${chalk.blueBright(bitsUtils.printBuffer(binaryData))} saved to file`);
  //
  axios
